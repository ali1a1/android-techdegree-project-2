...
public class Player implements Comparable<Player>, Serializable {
  ...
  public String toString() {
    return String.format("%s (%d inches - %s)",                     
                        getFullName(),                      
                        heightInInches,
  ...
  public static Comparator<Player> HeightComperator = new Comparator<Player>() {
    @Override
    public int compare(Player p1, Player p2) {
      int answer = p1.getHeightInInches() - (p2.getHeightInInches());
      if(answer == 0)
